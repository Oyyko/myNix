...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Colin Zhang"
    user-mail-address "hello@oyyko.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/jia/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/jia/bin" "/profile/bin" "/Users/jia/.npm-packages/bin" "/Users/jia/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
